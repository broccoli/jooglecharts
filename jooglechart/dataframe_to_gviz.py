...
def dataframe_to_gviz(in_df, datetime_cols=None, allow_nulls=False):
    ...
    if allow_nulls == False and in_df.isnull().any().any():
    ...
    description = get_description_from_dataframe(in_df, datetime_cols)


    data = get_list_from_dataframe(in_df, allow_nulls)
